...
/// The customer-screen half of the oracle's `_CONFIRM_GATED` table. The other
/// eight entries (case/ticket/orders/subscriptions/catalog) land with their own
/// screens.
const CONFIRM_GATED: [(&str, &str); 2] = [
